    ...
    public partial class AlunoViewModel : BaseViewModel
    {
        ...
        public async Task SearchByCpfAsync()
        {
            ...
            try
            {
                ...
                var escolha = await Shell.Current.DisplayActionSheet("Vários alunoes encontrados", "Cancelar", null, options);
        ...
        public async Task SelecionarFotoAsync()
        {
            try
            {
                ...
                if (result != null)
                {
                    ...
                    string contentType = Path.GetExtension(result.FileName)?.ToLower();
