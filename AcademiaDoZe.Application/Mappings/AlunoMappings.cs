...
namespace AcademiaDoZe.Application.Mappings
{
    public static class AlunoMappings
    {
        ...
        */
        ...
        {
            return Aluno.Criar(
             alunoDto.Nome, alunoDto.Cpf, alunoDto.DataNascimento, alunoDto.Telefone, alunoDto.Email!, alunoDto.Endereco.ToEntity(), alunoDto.Numero, alunoDto.Complemento!,
        ...
        {
            return Aluno.Criar(
             alunoDto.Nome ?? aluno.Nome, aluno.Cpf, // CPF não pode ser alterado
