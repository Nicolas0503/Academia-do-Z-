...
namespace AcademiaDoZe.Domain.Tests
{
    public class LogradouroDomainTests
    {
        ...
        {
            var logradouro = Logradouro.Criar(12345678 , " Rua A ", " Centro ", " Cidade ", "S P", "Brasil ", "");
        ...
        {
            var exception = Assert.Throws<DomainException>(() => Logradouro.Criar(12345678, "", "Centro", "Cidade", "SP", "Brasil", ""));
